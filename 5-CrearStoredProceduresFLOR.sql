...
CREATE PROCEDURE [OOZMA_KAPPA].[traerListadoTarjetaActivasPorClienteID]
	...
	@Fecha datetime
AS
	SELECT tarjeta_id AS tarjeta_numero,tarjeta_emisor,tarjeta_fecha_emision,tarjeta_vencimiento, tarjeta_codigo_seguridad, tarjeta_estado FROM OOZMA_KAPPA.Tarjeta
