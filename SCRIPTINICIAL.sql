...
CREATE TABLE [OOZMA_KAPPA].[Cuenta](
	...
	[cuenta_estado] bool NOT NULL DEFAULT(True),
...
CREATE TABLE [OOZMA_KAPPA].[Usuario](
	...
	[usuario_estado] [bool] NOT NULL DEFAULT(True),  --puede estar habilitado como no habilitado, ya sea por el estado del rol, o por logins incorrectos
